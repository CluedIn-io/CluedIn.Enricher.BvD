...
public class Datum
{
    [JsonProperty("ADDRESS_LINE1")] public string ADDRESS_LINE1 { get; set; }

    [JsonProperty("ADDRESS_LINE2")] public string ADDRESS_LINE2 { get; set; }

    [JsonProperty("ADDRESS_LINE3")] public string ADDRESS_LINE3 { get; set; }

    [JsonProperty("ADDRESS_LINE4")] public string ADDRESS_LINE4 { get; set; }

    [JsonProperty("POSTCODE")] public string POSTCODE { get; set; }

    [JsonProperty("CITY")] public string CITY { get; set; }

    [JsonProperty("CITY_STANDARDIZED")] public string CITY_STANDARDIZED { get; set; }

    [JsonProperty("COUNTRY")] public string COUNTRY { get; set; }

    [JsonProperty("COUNTRY_ISO_CODE")] public string COUNTRY_ISO_CODE { get; set; }

    [JsonProperty("COUNTRY_REGION")] public string COUNTRY_REGION { get; set; }

    [JsonProperty("COUNTRY_REGION_TYPE")] public string COUNTRY_REGION_TYPE { get; set; }
    ...
    [JsonProperty("WORLD_REGION")] public string WORLD_REGION { get; set; }

    [JsonProperty("US_STATE")] public string US_STATE { get; set; }

    [JsonProperty("ADDRESS_TYPE")] public string ADDRESS_TYPE { get; set; }

    [JsonProperty("PHONE_NUMBER")] public string PHONE_NUMBER { get; set; }

    [JsonProperty("FAX_NUMBER")] public string FAX_NUMBER { get; set; }
    ...
    [JsonProperty("STREET_SUPPLEMENT")] public string STREET_SUPPLEMENT { get; set; }

    [JsonProperty("PO_BOX")] public string PO_BOX { get; set; }

    [JsonProperty("MINOR_TOWN")] public string MINOR_TOWN { get; set; }
    ...
    [JsonProperty("POSTCODE_ADDITIONAL")] public string POSTCODE_ADDITIONAL { get; set; }

    [JsonProperty("CITY_ADDITIONAL")] public string CITY_ADDITIONAL { get; set; }

    [JsonProperty("CITY_STANDARDIZED_ADDITIONAL")]
    public string CITY_STANDARDIZED_ADDITIONAL { get; set; }

    [JsonProperty("COUNTRY_ADDITIONAL")] public string COUNTRY_ADDITIONAL { get; set; }

    [JsonProperty("COUNTRY_ISO_CODE_ADDITIONAL")]
    public string COUNTRY_ISO_CODE_ADDITIONAL { get; set; }

    [JsonProperty("LATITUDE_ADDITIONAL")] public string LATITUDE_ADDITIONAL { get; set; }

    [JsonProperty("LONGITUDE_ADDITIONAL")] public string LONGITUDE_ADDITIONAL { get; set; }
    ...
    [JsonProperty("BUILDING_ADDITIONAL")] public string BUILDING_ADDITIONAL { get; set; }

    [JsonProperty("STREET_ADDITIONAL")] public string STREET_ADDITIONAL { get; set; }
    ...
    [JsonProperty("PO_BOX_ADDITIONAL")] public string PO_BOX_ADDITIONAL { get; set; }

    [JsonProperty("MINOR_TOWN_ADDITIONAL")]
    public string MINOR_TOWN_ADDITIONAL { get; set; }

    [JsonProperty("TRADE_DESCRIPTION_EN")] public string TRADE_DESCRIPTION_EN { get; set; }
    ...
    [JsonProperty("PRODUCTS_SERVICES")] public string PRODUCTS_SERVICES { get; set; }
    ...
    [JsonProperty("NACE2_MAIN_SECTION")] public string NACE2_MAIN_SECTION { get; set; }

    [JsonProperty("NACE2_CORE_CODE")] public string NACE2_CORE_CODE { get; set; }

    [JsonProperty("NACE2_CORE_LABEL")] public string NACE2_CORE_LABEL { get; set; }

    [JsonProperty("NACE2_PRIMARY_CODE")] public string NACE2_PRIMARY_CODE { get; set; }

    [JsonProperty("NACE2_PRIMARY_LABEL")] public string NACE2_PRIMARY_LABEL { get; set; }

    [JsonProperty("NACE2_SECONDARY_CODE")] public string NACE2_SECONDARY_CODE { get; set; }

    [JsonProperty("NACE2_SECONDARY_LABEL")]
    public string NACE2_SECONDARY_LABEL { get; set; }

    [JsonProperty("NAICS2017_CORE_CODE")] public string NAICS2017_CORE_CODE { get; set; }

    [JsonProperty("NAICS2017_CORE_LABEL")] public string NAICS2017_CORE_LABEL { get; set; }
    ...
    [JsonProperty("USSIC_CORE_CODE")] public string USSIC_CORE_CODE { get; set; }

    [JsonProperty("USSIC_CORE_LABEL")] public string USSIC_CORE_LABEL { get; set; }

    [JsonProperty("USSIC_PRIMARY_CODE")] public string USSIC_PRIMARY_CODE { get; set; }

    [JsonProperty("USSIC_PRIMARY_LABEL")] public string USSIC_PRIMARY_LABEL { get; set; }

    [JsonProperty("USSIC_SECONDARY_CODE")] public string USSIC_SECONDARY_CODE { get; set; }

    [JsonProperty("USSIC_SECONDARY_LABEL")]
    public string USSIC_SECONDARY_LABEL { get; set; }

    [JsonProperty("BVD_ID_NUMBER")] public string BVD_ID_NUMBER { get; set; }

    [JsonProperty("BVD_ACCOUNT_NUMBER")] public string BVD_ACCOUNT_NUMBER { get; set; }

    [JsonProperty("ORBISID")] public string ORBISID { get; set; }

    [JsonProperty("NATIONAL_ID")] public string NATIONAL_ID { get; set; }

    [JsonProperty("NATIONAL_ID_LABEL")] public string NATIONAL_ID_LABEL { get; set; }

    [JsonProperty("NATIONAL_ID_TYPE")] public string NATIONAL_ID_TYPE { get; set; }

    [JsonProperty("TRADE_REGISTER_NUMBER")]
    public string TRADE_REGISTER_NUMBER { get; set; }

    [JsonProperty("VAT_NUMBER")] public string VAT_NUMBER { get; set; }

    [JsonProperty("EUROPEAN_VAT_NUMBER")] public string EUROPEAN_VAT_NUMBER { get; set; }

    [JsonProperty("LEI")] public string LEI { get; set; }

    [JsonProperty("GIIN")] public string GIIN { get; set; }

    [JsonProperty("STATISTICAL_NUMBER")] public string STATISTICAL_NUMBER { get; set; }

    [JsonProperty("COMPANY_ID_NUMBER")] public string COMPANY_ID_NUMBER { get; set; }
    ...
    [JsonProperty("LEI_STATUS")] public string LEI_STATUS { get; set; }
    ...
    [JsonProperty("RELEASE_DATE")] public string RELEASE_DATE { get; set; }

    [JsonProperty("INFORMATION_PROVIDER")] public string INFORMATION_PROVIDER { get; set; }

    [JsonProperty("NAME")] public string NAME { get; set; }

    [JsonProperty("PREVIOUS_NAME")] public string PREVIOUS_NAME { get; set; }

    [JsonProperty("PREVIOUS_NAME_DATE")] public string PREVIOUS_NAME_DATE { get; set; }

    [JsonProperty("AKA_NAME")] public string AKA_NAME { get; set; }

    [JsonProperty("STATUS")] public string STATUS { get; set; }

    [JsonProperty("STATUS_DATE")] public string STATUS_DATE { get; set; }

    [JsonProperty("STATUS_CHANGE_DATE")] public string STATUS_CHANGE_DATE { get; set; }

    [JsonProperty("LOCAL_STATUS")] public string LOCAL_STATUS { get; set; }

    [JsonProperty("LOCAL_STATUS_DATE")] public string LOCAL_STATUS_DATE { get; set; }
    ...
    [JsonProperty("NATIONAL_LEGAL_FORM")] public string NATIONAL_LEGAL_FORM { get; set; }

    [JsonProperty("INCORPORATION_DATE")] public string INCORPORATION_DATE { get; set; }

    [JsonProperty("INCORPORATION_STATE")] public string INCORPORATION_STATE { get; set; }

    [JsonProperty("ENTITY_TYPE")] public string ENTITY_TYPE { get; set; }

    [JsonProperty("ICIJ_DATA_PRESENCE_INDICATOR")]
    public string ICIJ_DATA_PRESENCE_INDICATOR { get; set; }

    [JsonProperty("CONSOLIDATION_CODE")] public string CONSOLIDATION_CODE { get; set; }

    [JsonProperty("CLOSING_DATE_LAST_ANNUAL_ACCOUNTS")]
    public string CLOSING_DATE_LAST_ANNUAL_ACCOUNTS { get; set; }

    [JsonProperty("YEAR_LAST_ACCOUNTS")] public string YEAR_LAST_ACCOUNTS { get; set; }
    ...
    [JsonProperty("NUMBER_YEARS")] public string NUMBER_YEARS { get; set; }
}
